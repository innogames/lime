...
class Cairo {
	...
	public var operat0r (get, set):CairoOperator;
	...
	@:noCompletion private function get_operat0r ():CairoOperator {
	...
	@:noCompletion private function set_operat0r (value:CairoOperator):CairoOperator {
